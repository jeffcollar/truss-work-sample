...
This is a python 3 solution (it was written and tested with 3.6.8), python can be downloaded here <https://www.python.org/downloads/>.  This solution does not require any additional packages or the use of a virtual environment.
...
chmod +x main.py
./main.py [INPUT_FILE_PATH] >> [OUTPUT_FILE_PATH]
```

If no ```[OUTPUT_FILE_PATH]``` is provided the output will go to the console.
